...
describe 'Order show page' do
  ...
  describe 'discounts appear on show' do
    before :each do
      @user = User.create!(name: 'Harold Guy',
                           address: '123 Macho St',
                           city: 'Lakewood',
      ...
      @twenty_for_ten = @mike.discounts.create(quantity: 20, percentage: 10)
      @fifty_for_twenty_five = @mike.discounts.create(quantity: 50, percentage: 25)

      @tire = @meg.items.create(name: 'Gatorskins', description: "They'll never pop!", price: 100, image: 'https://www.rei.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588', inventory: 75)
      @paper = @mike.items.create(name: 'Lined Paper', description: 'Great for writing on!', price: 20, image: 'https://cdn.vertex42.com/WordTemplates/images/printable-lined-paper-wide-ruled.png', inventory: 200)
      @pencil = @mike.items.create(name: 'Yellow Pencil', description: 'You can write on paper with it!', price: 2, image: 'https://images-na.ssl-images-amazon.com/images/I/31BlVr01izL._SX425_.jpg', inventory: 100)
    ...
    it "Discounts show up on the order show page" do
      ...
      within "#item-#{@item_order_3.item_id}" do
