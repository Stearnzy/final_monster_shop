...
describe 'As a registered user, merchant, or admin' do
  describe 'When I visit the logout path' do
    it "I am redirected to the home page of the site and I
      ...
      bike_shop = Merchant.create(name: "Meg's Bike Shop", address: '123 Bike Rd.', city: 'Denver', state: 'CO',
                                  zip: 80_203)
      tire = bike_shop.items.create(name: 'Gatorskins', description: "They'll never pop!", price: 100,
                                    image: 'https://www.rei.com/media/4e1f5b05-27ef-4267-bb9a-14e35935f218?size=784x588', inventory: 12)
